...
parser.add_argument('--ref_file', type=str, default='data/anlg/test.multi.ref')
parser.add_argument('--pred_file', type=str, default='res/anlg_test_aug_xl_deberta_filter_t5_xl_0419.txt')
...
print(args.pred_file.split('/')[-1][:-4], average_f1_score, sep='\t')
